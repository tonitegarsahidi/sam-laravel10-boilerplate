...
@section('main-content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="m-4">
                <a class="btn btn-primary me-2" href="{{ route('user.setting.changePassword', ['id' => $data->id]) }}"
                    title="update this user">
                    <i class='tf-icons bx bx-pencil me-2'></i>Change Password</a>
                <a class="btn btn-danger me-2" href="{{ route('user.setting.changeProfile', ['id' => $data->id]) }}"
                    title="delete user">
